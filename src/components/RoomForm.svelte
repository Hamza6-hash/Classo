...
<div class="flex fixed top-32 flex-col items-center justify-center w-full">
  <svg
    on:keydown={() => {
      showForm = false;
    }}
    ...
    class="hover:cursor-pointer fixed top-36 z-50 icon"
    viewBox="0 0 32 32"
    version="1.1"
    width="28"
    height="28"
  ...
  >
    ...
    <input
      type="text"
      class="border-b bg-black h-8 p-2 focus:outline-none border-red-600 focus:border-green-500"
